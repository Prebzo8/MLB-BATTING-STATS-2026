...
URL = f"https://www.fangraphs.com/leaders-legacy.aspx?pos=all&stats=bat&lg=all&qual=0&type=c,6,34,35,36,23,21,37,38,39,40,53,41,52,51,50,54&season=2026&month=15&season1=2026&ind=0&team=0,ts&rost=0&age=0&filter=&players=0&startdate={{start_date}}&enddate={{end_date}}&v_cr=legacy"

logging.info(f"📥 Scraping Teams — {SPLIT_NAME} | {DATE_RANGE} ({start_date if '30' != 'None' else '2026-01-01'}) → {end_date}")
