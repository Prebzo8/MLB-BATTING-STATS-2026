...
URL = f"https://www.fangraphs.com/leaders-legacy.aspx?pos=all&stats=bat&lg=all&qual=0&type=1&season=2026&month=0&season1=2026&ind=0&team=0,ts&rost=0&age=0&filter=&players=0&startdate={{start_date}}&enddate={{end_date}}"
